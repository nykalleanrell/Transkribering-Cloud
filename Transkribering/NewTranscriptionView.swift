...
struct NewTranscriptionView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                            ...
                            VStack(spacing: 10) {
                                if let url = selectedURL {
                                    ...
                                    Text("MP3, WAV, M4A, MP4, FLAC")
                                        .font(.system(size: 12))
                                        .foregroundColor(.secondary)
                                    Button("Valj fil") { openFilePicker() }
                                        .font(.system(size: 13))
                                        .padding(.top, 4)
                                }
                            }
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Sprak").font(.system(size: 13, weight: .medium))
            ...
            HStack {
                ...
                .disabled(selectedURL == nil || isTranscribing)
    ...
    private func handleDrop(providers: [NSItemProvider]) -> Bool {
        ...
        // Försök flera identifierare för maximal kompatibilitet
    ...
    private func startTranscription() {
        ...
        whisper.transcribe(url: url, language: language) { result in
